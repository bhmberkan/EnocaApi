    ...
    public partial class mig_1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CarrierConfigurationsId = table.Column<int>(type: "int", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CarrierConfigurations", x => x.CarrierConfigurationsId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CarriersId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CarrierName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CarrrierIsActive = table.Column<bool>(type: "bit", nullable: false),
